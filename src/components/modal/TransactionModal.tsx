  ...
  return (
    ...
    >
      ...
      <div className="bg-card rounded-2xl p-1 flex justify-between">
        ...
        <button
          className={`px-16 rounded-2xl h-8 font-semibold flex items-center justify-center cursor-pointer ${transitionType === "despesas" && `bg-accent-green/10 text-accent-green transition-all duration-200 ease-in-out`}`}
      ...
      <form className="space-y-4 grid grid-cols-2 items-center gap-3">
        <label htmlFor="description" className="space-y-3">
          <p>Descrição</p>
          <input
            type="text"
            id="description"
            className="border border-hover rounded-lg bg-card py-2 px-2 text-sm not-placeholder-shown:border-accent-gold ring-accent-gold outline-none w-full "
        ...
        <label htmlFor="wage" className="space-y-3">
          ...
          <input
            type="text"
            id="wage"
            className="border border-hover rounded-lg bg-card py-2 px-2 text-sm not-placeholder-shown:border-accent-gold ring-accent-gold outline-none w-full font-mono"
        ...
        <div className="flex gap-3 text-xs font-semibold">
          ...
          <button className="bg-linear-to-r from-accent-gold to-accent-gold/90 py-2 px-1 rounded-xl text-base shadow-xl/30 shadow-accent-gold cursor-pointer">
            Salvar Transação
          </button>
        </div>
      </form>
